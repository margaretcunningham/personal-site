...
const Index = () => (
  <Main description="Margaret Cunningham's personal website">
    <article className="post" id="index">
      ...
      <p>
        Welcome to my personal website! I&apos;m Margaret Cunningham, a recent graduate of the
      ...
      <p> Source available <a href="https://github.com/margaretcunningham/personal-site">here</a>.</p>
    </article>
  </Main>
);
